...
// const [background, setBackground] = useState(ReadingPlansList[0].img)
    ...
    if (activeIndex === 0) {
        currentPlansList = ReadingPlansList;
    } else {
        currentPlansList = FamilyPlansList;
    }
    const [background, setBackground] = useState(currentPlansList[0].img);
                     ...
                     <View style={styles.slideView}>
                         <Carousel
                             ...
                             onSnapToItem={(index) => {
                                 ...
                                 setBackground(currentPlansList[0].img)
                                 ...
                                 }
                                 {
                                     ...
                                     (
                                         <Text style={{
                                             ...
                                             Subscribe to this package and get access to 150+ life Changing articles for 3 MONTHS
                                         </Text>
                                     )
                                 }
                                 {
                                     ...
                                     (
                                         <Text style={{
                                             ...
                                             Subscribe to this package and get access to 365+ life Changing articles for 1 YEAR
                                         </Text>
                                     )
                                 }
