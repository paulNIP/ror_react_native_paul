const IMAGE = {
    ...
    MAP_ICON: require("../assets/maps.png"),
    TICKET_ICON: require("../assets/blank-ticket.png"),
    LIVE_ICON: require("../assets/livestream.png"),
    NOTIFICATION_ICON: require("../assets/notification.png"),
  };
