...
import { getDivineHealing, getFaithProsperity, getSoulWining } from "../service/storeService";
    ...
    <View>
        ...
        <View>
            ...
            <View style={{flex:1,flexDirection:'row',justifyContent:'space-between'}}>
                ...
                <Text style={{marginLeft:10,fontWeight:'bold',flexWrap:'wrap'}}>Soul Wining</Text>
